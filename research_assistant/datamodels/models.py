...
class ResponseMetadata(BaseModel):
    ...
    app_display_language: constr(
        strip_whitespace=True,
        regex=p.SOFTWARE_LOCALE_STRING
        ) = Field(
